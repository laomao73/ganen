...
企业认证一<br/>
<form action="/companyLogin/authOne.do" method="post" >
...
企业认证二<br/>
<form action="/company/authTwo.do" method="post" >
...
<%--</script>--%>
<%--<form action="/company/uploadImage.do" method="post" enctype="multipart/form-data">--%>
