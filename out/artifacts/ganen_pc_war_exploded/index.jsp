...
选择服务类型<br/>
<form action="/company/chooseBear.do" method="post">
    <input type="text" name="type">
    <input type="submit">
</form>
...
<%--<form action="/company/authFinish.do" method="post">--%>
...
<%--&lt;%&ndash;<div id="dropz" class="dropzone" enctype="multipart/form-data"/>&ndash;%&gt;--%>
<%--<input type="submit">--%>
<%--</form>--%>
